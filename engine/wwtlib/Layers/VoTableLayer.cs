...
namespace wwtlib
{
    ...
    public class VoTableLayer : Layer
    {
      ...
      //  public VOTableViewer Viewer = null;
        ...
        public void UpdateFrom(IVoTableLayerSettings settings)
        {
            ...
            AutoUpdate = settings.AutoUpdate ?? AutoUpdate;
            ...
            if (settings.DataSourceUrl != null)
            {
                DataSourceUrl = settings.DataSourceUrl;
            }
