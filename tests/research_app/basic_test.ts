...
type ResearchAppTests = NightwatchTests & {
    app: PageObjectModel & ResearchAppPage;
}

const tests: ResearchAppTests = {
    ...
    'Initial configuration': function () {
        const app = this.app;
        const sections = app.sections! as ResearchAppSections;
